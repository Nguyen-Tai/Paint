    ...
    class Ellipse:FillShape
    {
        protected override GraphicsPath GraphicsPathObject
        {
            get
            {
                ...
                {
                    path.AddEllipse(new Rectangle(this.p2, new Size(this.p1.X - this.p2.X, this.p1.Y - this.p2.Y)));
                }
                else if (this.p1.X > this.p2.X && this.p1.Y < this.p2.Y)
                {
                    path.AddEllipse(new System.Drawing.Rectangle(new Point(this.p2.X, this.p1.Y), new Size(this.p1.X - this.p2.X, this.p2.Y - this.p1.Y)));
                }
                else if (this.p1.X < this.p2.X && this.p1.Y > this.p2.Y)
                {
                    path.AddEllipse(new System.Drawing.Rectangle(new Point(this.p1.X, this.p2.Y), new Size(this.p2.X - this.p1.X, this.p1.Y - this.p2.Y)));
                }
                else  // xuống phải
                {
                    path.AddEllipse(new System.Drawing.Rectangle(this.p1, new Size(this.p2.X - this.p1.X, this.p2.Y - this.p1.Y)));
                }
                return path;
            }
        }
